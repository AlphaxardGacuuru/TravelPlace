...
<form action="{{ url('admin/page/service/update') }}"
	  method="post">
	@csrf
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<textarea name="detail"
						  ...
						  cols="30"
						  rows="10">{{ $page_service->detail }}</textarea>
			</div>
			<div class="form-group">
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<textarea name="seo_meta_description"
						  ...
						  cols="30"
						  rows="10">{{ $page_service->seo_meta_description }}</textarea>
			</div>
