...
<form action="{{ url('admin/slider/update/'.$slider->id) }}"
	  method="post"
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<textarea name="slider_text"
						  ...
						  cols="30"
						  rows="10">{{ $slider->slider_text }}</textarea>
			</div>
			<div class="form-group">
				...
				<input type="text"
					   ...
					   class="form-control"
					   value="{{ $slider->slider_button_text }}"
					   autofocus>
			</div>
			<div class="form-group">
				...
				<input type="text"
					   ...
					   class="form-control"
					   value="{{ $slider->slider_button_url }}"
					   autofocus>
			</div>
			<div class="form-group">
				<label for="">Existing Slider Photo</label>
				<div>
					<img src="{{ asset('public/uploads/'.$slider->slider_photo) }}"
						 alt=""
						 class="w_200">
				</div>
			</div>
