...
<form action="{{ url('admin/team-member/update/'.$team_member->id) }}"
	  method="post"
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<textarea name="detail"
						  ...
						  cols="30"
						  rows="10">{{ $team_member->detail }}</textarea>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text"
					   name="website"
					   class="form-control"
					   value="{{ $team_member->website }}">
			</div>
			<div class="form-group">
				<label for="">Existing Photo</label>
				<div>
					<img src="{{ asset('public/uploads/'.$team_member->photo) }}"
						 alt=""
						 class="w_150">
				</div>
			</div>
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<textarea name="seo_meta_description"
						  ...
						  cols="30"
						  rows="10">{{ $team_member->seo_meta_description }}</textarea>
			</div>
			@can("update-web-section")
			<button type="submit"
