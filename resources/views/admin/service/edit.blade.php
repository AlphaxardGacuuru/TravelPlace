...
<form action="{{ url('admin/service/update/'.$service->id) }}"
	  method="post"
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<textarea name="short_description"
						  ...
						  cols="30"
						  rows="10">{{ $service->short_description }}</textarea>
			</div>
			<div class="form-group">
				<label for="">Existing Photo</label>
				<div>
					<img src="{{ asset('public/uploads/'.$service->photo) }}"
						 alt=""
						 class="w_200">
				</div>
			</div>
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<textarea name="seo_meta_description"
						  class="form-control h_100"
						  cols="30"
						  rows="10">{{ $service->seo_meta_description }}</textarea>
			</div>
