...
<form action="{{ url('admin/currency/update') }}"
	  method="post">
	@csrf
				...
				<div class="card-body">
					<div class="form-group">
						...
						<input type="text"
							   name="currency_name"
							   class="form-control"
							   value="{{ $general_setting->currency_name }}">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text"
							   name="currency_sign"
							   class="form-control"
							   value="{{ $general_setting->currency_sign }}">
					</div>
					<div class="form-group">
						<label for="">Currency value (per USD)</label>
						<input type="text"
							   name="currency_per_usd_value"
							   class="form-control"
							   value="{{ $general_setting->currency_per_usd_value }}">
					</div>
