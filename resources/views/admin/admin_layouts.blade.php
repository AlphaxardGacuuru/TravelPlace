	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"
			...
			<li class="nav-item @if($conName[1] == 'setting' && $conName[2] == 'general') active @endif">
				...
				<div id="collapseSetting"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item @if($conName[3] == 'layout') active @endif"
						   href="{{ route('admin.general_setting.layout') }}">Layout</a>
					</div>
				</div>
			</li>
			...
			<li class="nav-item @if($conName[1] == 'page' || $conName[1] == 'page_home_update') active @endif">
				@can("read-page-settings")
				<a class="nav-link collapsed"
				   href="#"
				   data-toggle="collapse"
				   data-target="#collapsePageSettings"
				   aria-expanded="true"
				   aria-controls="collapsePageSettings">
					<i class="fas fa-paste"></i>
					<span>Page Settings</span>
				</a>
				@endcan
				<div id="collapsePageSettings"
					 class="collapse @if($conName[1] == 'page' || $conName[1] == 'page_home_update') show @endif"
					 aria-labelledby="headingPages"
					 data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item @if($conName[1] == 'page_home_update') active @endif"
						...
						<a class="collapse-item @if($conName[2] == 'testimonial') active @endif"
						   href="{{ route('admin.page_testimonial.edit') }}">Testimonial</a>
						<a class="collapse-item @if($conName[2] == 'destination') active @endif"
						   href="{{ route('admin.page_destination.edit') }}">Destination</a>
						<a class="collapse-item @if($conName[2] == 'package') active @endif"
						   href="{{ route('admin.page_package.edit') }}">Package</a>
			...
			<li class="nav-item @if($conName[1] == 'payment' || $conName[1] == 'currency') active @endif">
				...
				<div id="collapsePayment"
					 class="collapse @if($conName[1] == 'payment' || $conName[1] == 'currency') show @endif"
					 aria-labelledby="headingPages"
					 data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item"
						   href="{{ route('admin.payment') }}">Payment Information</a>
						<a class="collapse-item"
						   href="{{ route('admin.currency') }}">Currency Setup</a>
					</div>
				</div>
			</li>
			...
			<li class="nav-item @if($conName[1] == 'category' || $conName[1] == 'blog') active @endif">
				...
				@endcan
				<div id="collapseBlog"
					 class="collapse @if($conName[1] == 'category' || $conName[1] == 'blog') show @endif"
					 aria-labelledby="headingPages"
					 data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item"
			...
			<!-- Website Section -->
			<li
				class="nav-item @if($conName[1] == 'slider' || $conName[1] == 'service' || $conName[1] == 'testimonial' || $conName[1] == 'team-member' || $conName[1] == 'faq' || $conName[1] == 'social-media') active @endif">
				@can("read-web-section")
				<a class="nav-link collapsed"
				   href="#"
				   data-toggle="collapse"
				...
				<div id="collapseWebsite"
					 class="collapse @if($conName[1] == 'slider' || $conName[1] == 'client' || $conName[1] == 'service' || $conName[1] == 'testimonial' || $conName[1] == 'team-member' || $conName[1] == 'faq' || $conName[1] == 'social-media') show @endif"
					 aria-labelledby="headingPages"
					 data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item"
						   href="{{ route('admin.slider.index') }}">Sliders</a>
						<a class="collapse-item"
						   href="{{ route('admin.client.index') }}">Client</a>
						<a class="collapse-item"
						   href="{{ route('admin.service.index') }}">Services</a>
						<a class="collapse-item"
						   href="{{ route('admin.testimonial.index') }}">Testimonials</a>
						<a class="collapse-item"
						   href="{{ route('admin.team_member.index') }}">Team Members</a>
						<a class="collapse-item"
						   href="{{ route('admin.faq.index') }}">FAQ</a>
						<a class="collapse-item"
						   href="{{ route('admin.social_media.index') }}">Social Media</a>
					</div>
				</div>
			</li>
			...
			<li class="nav-item @if($conName[1] == 'traveller') active @endif">
				@can("read-traveller")
				<a class="nav-link"
				   href="{{ route('admin.traveller.index') }}">
			...
			<li class="nav-item @if($conName[1] == 'subscriber') active @endif">
				...
				<a class="nav-link collapsed"
				   href="#"
				   data-toggle="collapse"
				   data-target="#collapseSubscriber"
				   aria-expanded="true"
				   aria-controls="collapseSubscriber">
					<i class="fas fa-share-alt-square"></i>
					<span>Subscriber</span>
				</a>
				@endcan
				<div id="collapseSubscriber"
					 class="collapse @if($conName[1] == 'subscriber') show @endif"
					 aria-labelledby="headingPages"
					 data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item"
						...
						<a class="collapse-item"
						   href="{{ route('admin.subscriber.send_email') }}">Send Email to Subscribers</a>
					</div>
				</div>
			</li>
						...
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle"
							   ...
							   aria-expanded="false">
								...
								<img class="img-profile rounded-circle"
									 src="{{ asset('uploads/'.session('photo')) }}">
							</a>
							...
							<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
								...
								<a class="dropdown-item"
								   href="{{ route('admin.profile_change') }}">
